(function($) {
	...
	if($('.typing').length == 1){
		...
		{
			strings: ["know more about me, go to the About section", "see my projects, go to the Project section", "know about my skills, go to the Skills section", "connect with me, go to the Contact section"], 
			typeSpeed: 100,
			backSpeed: 60,
			loop: true
		});
